...
#define STRING_CONFIG_H_AUTHOR "(Mihael Sinkec, CR-10 S4)" // Who made the changes.
...
#define INVERT_E0_DIR false // Stock Creality CR-10 S4
...
#define X_BED_SIZE 410 // Nozzle is at X4 when homed
#define Y_BED_SIZE 410 // Nozzle is at Y2 when homed
